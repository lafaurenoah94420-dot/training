...
if type(main.grille) ~= "function" then
  print("❌ Fonction grille manquante")
  os.exit(1)
end
...
_tester("grille(2, 3) → 6", main.grille(2, 3), 6)
_tester("grille(1, 1) → 1", main.grille(1, 1), 1)
_tester("grille(4, 2) → 8", main.grille(4, 2), 8)
