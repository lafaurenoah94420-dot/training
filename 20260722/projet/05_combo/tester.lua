...
if type(main.barre) ~= "function" then
  print("❌ Erreur : la fonction barre n'est pas définie")
  os.exit(1)
end
...
_tester('barre(50, 100) → "50%"', main.barre(50, 100), "50%")
_tester('barre(1, 3) → "33%"', main.barre(1, 3), "33%")
_tester('barre(0, 10) → "0%"', main.barre(0, 10), "0%")
_tester('barre(10, 10) → "100%"', main.barre(10, 10), "100%")
