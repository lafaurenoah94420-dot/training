...
if type(main.nettoyer) ~= "function" then
  print("❌ Erreur : la fonction nettoyer n'est pas définie")
  os.exit(1)
end
...
_tester('nettoyer("  JOEL  ") → "joel"', main.nettoyer("  JOEL  "), "joel")
_tester('nettoyer("Ellie") → "ellie"', main.nettoyer("Ellie"), "ellie")
_tester('nettoyer("X") → "x"', main.nettoyer("X"), "x")
