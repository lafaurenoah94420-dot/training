...
_tester("ok_soin == true", main.ok_soin, true)
_tester("resultat_soin == 65", main.resultat_soin, 65)
_tester("ok_porte == false", main.ok_porte, false)
_tester("message_porte est un texte", type(main.message_porte) == "string", true)
