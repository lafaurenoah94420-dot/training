...
if type(main.ecart) ~= "function" then
  print("❌ Fonction ecart manquante"); os.exit(1)
end
...
_tester("ecart(10, 3) → 7", main.ecart(10, 3), 7)
_tester("ecart(3, 10) → 7", main.ecart(3, 10), 7)
_tester("ecart(5, 5) → 0", main.ecart(5, 5), 0)
