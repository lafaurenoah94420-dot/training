-- ============================================================
-- Tester — Défaut dans une fonction
-- ============================================================
...
_tester("soigner(50) → 70", main.soigner(50), 70)
_tester("soigner(50, 40) → 90", main.soigner(50, 40), 90)
_tester("soigner(90, 20) → 110", main.soigner(90, 20), 110)
