...
_tester("inventaire est une table", type(main.inventaire) == "table", true)
_tester("#inventaire == 3", #main.inventaire, 3)
_tester('inventaire[1] == "herb"', main.inventaire[1], "herb")
_tester('inventaire[2] == "ammo"', main.inventaire[2], "ammo")
_tester('inventaire[3] == "clé"', main.inventaire[3], "clé")
