...
if type(main.minuscules) ~= "function" then
  print("❌ la fonction minuscules n'est pas définie")
  os.exit(1)
end

_tester('minuscules("LEON") → "leon"', main.minuscules("LEON"), "leon")
_tester('minuscules("Ok") → "ok"', main.minuscules("Ok"), "ok")
