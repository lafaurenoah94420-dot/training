...
if type(main.etiquette) ~= "function" then
  print("❌ la fonction etiquette n'est pas définie")
  os.exit(1)
end


if type(main.nettoyer) ~= "function" then
  print("❌ la fonction nettoyer n'est pas définie")
  os.exit(1)
end

_tester('etiquette', main.etiquette("Joel", 80), "JOEL a 80 PV")
_tester('etiquette 2', main.etiquette("ellie", 50), "ELLIE a 50 PV")
_tester('nettoyer', main.nettoyer("Zombie Zone"), "Infecté Zone")
