...
if type(main.remplacer) ~= "function" then
  print("❌ la fonction remplacer n'est pas définie")
  os.exit(1)
end

_tester('zombie → infecté', main.remplacer("un zombie"), "un infecté")
_tester('deux', main.remplacer("zombie zombie"), "infecté infecté")
_tester('rien', main.remplacer("ok"), "ok")
