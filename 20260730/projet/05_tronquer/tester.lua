...
if type(main.debut) ~= "function" then
  print("❌ la fonction debut n'est pas définie")
  os.exit(1)
end

_tester('debut("Jackson", 4) → "Jack"', main.debut("Jackson", 4), "Jack")
_tester('debut("Ellie", 2) → "El"', main.debut("Ellie", 2), "El")
