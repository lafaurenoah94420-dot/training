...
if type(main.longueur) ~= "function" then
  print("❌ la fonction longueur n'est pas définie")
  os.exit(1)
end

_tester('longueur("Joel") → 4', main.longueur("Joel"), 4)
_tester('longueur("") → 0', main.longueur(""), 0)
_tester('longueur("abc") → 3', main.longueur("abc"), 3)
