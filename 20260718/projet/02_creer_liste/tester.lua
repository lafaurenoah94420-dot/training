...
_tester("#loot == 3", #main.loot, 3)
_tester("loot[1] == \"cle\"", main.loot[1], "cle")
_tester("loot[2] == \"montre\"", main.loot[2], "montre")
_tester("loot[3] == \"cash\"", main.loot[3], "cash")
