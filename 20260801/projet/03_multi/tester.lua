...
if type(main.stats) ~= "function" then
  print("❌ la fonction stats n'est pas définie")
  os.exit(1)
end

local a, b = main.stats(40, 10)
_tester("1er retour == 40", a, 40)
_tester("2e retour == 10", b, 10)
local c, d = main.stats(100, 0)
_tester("stats(100,0)", c == 100 and d == 0, true)
