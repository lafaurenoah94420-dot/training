...
-- variables attendues (pas de fonction)
...
_tester("vie_finale == 100", main.vie_finale, 100)
_tester("vie_plancher == 0", main.vie_plancher, 0)
_tester("nom_affiche == \"JOEL\"", main.nom_affiche, "JOEL")
