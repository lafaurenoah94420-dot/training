...
_tester("soigner(60, 20) → 80", main.soigner(60, 20), 80)
_tester("soigner(90, 20) → 100", main.soigner(90, 20), 100)
_tester("soigner(100, 50) → 100", main.soigner(100, 50), 100)
_tester("soigner(0, 25) → 25", main.soigner(0, 25), 25)
