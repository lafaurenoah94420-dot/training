...
if type(main.vie_maximale) ~= "function" then
  print("❌ Erreur : la fonction vie_maximale n'est pas définie dans main.lua")
  print("   → Vérifie que tu as bien écrit : function vie_maximale()")
  os.exit(1)
end
...
_tester("vie_maximale() → 100", main.vie_maximale(), 100)
_tester("vie_maximale() encore → 100", main.vie_maximale(), 100)
